Contributing to Bifrost Core
============================

The Bifrost Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bifrost Core project, and is not to be
confused with overall Bifrost Network Protocol consensus changes.

Whether a pull request is merged into Bifrost Core rests with the project merge
...
Patches that change Bifrost consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bifrost consensus, it must have been
...
The project leader is the release manager for each Bifrost Core release.

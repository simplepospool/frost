...
In order to support loading of multiple wallets in bifrost-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bifrost.cpp.
...
Changes to bifrost.cpp
----------------------
bifrost.cpp is the entry point into bifrost-qt, and as such, will require some minor modifications to provide hooks for

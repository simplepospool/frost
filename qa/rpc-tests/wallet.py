...
#   c) node1 mines 32 blocks, so now node 0 has 60001frost, node 1 has 4250frost, node2 has none.
#   d) node0 sends 601 frost to node2, in two transactions (301 frost, then 300 frost).

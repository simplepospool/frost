...
/* Bifrost GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bifrost"
#define QAPP_ORG_DOMAIN "bifrostcoin.io"
#define QAPP_APP_NAME_DEFAULT "Bifrost-Qt"
#define QAPP_APP_NAME_TESTNET "Bifrost-Qt-testnet"

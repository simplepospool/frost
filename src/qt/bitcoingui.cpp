                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bifrost Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bifrost address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bifrost: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFROST"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bifrost Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bifrost Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bifrost"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bifrost addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bifrost addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bifrost: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bifrost Core help message to get a list with possible Bifrost command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bifrost Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bifrost network", "", count));
}
...
{
    QString strTitle = tr("Bifrost Core"); // default title

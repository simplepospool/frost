...
/** Utility functions used by the Bifrost Qt UI.
 */
namespace GUIUtil
{
...
// Render Bifrost addresses in monospace font
...
// Parse "bifrost:" URI into recipient object, return true on successful parsing

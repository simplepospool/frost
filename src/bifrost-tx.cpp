...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bifrost Core bifrost-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bifrost-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bifrost transaction") + "\n" +
                               "  bifrost-tx [options] -create [commands]   " + _("Create hex-encoded bifrost transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bifrost transaction

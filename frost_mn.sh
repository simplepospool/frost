...
COIN_TGZ='https://github.com/bifrost-actual/bifrost-coin/releases/download/v1.1.0/bifrost-1.1-aarch64-linux-gnu.tar.gz'
COIN_NAME='Bifrost'
COIN_PORT=9229
RPC_PORT=9228
...
function download_node() {
  ...
  wget -qO- $COIN_TGZ | tar xvz --show-progress
  compile_error
  rm $COIN_TGZ
  chmod +x *
...
bantime=60
addnode=52.26.253.109
addnode=52.11.62.231
addnode=34.219.150.132
addnode=34.219.45.27
addnode=54.244.8.88
addnode=52.26.212.126
EOF
}
